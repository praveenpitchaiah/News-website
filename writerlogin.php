...
<div id="login-form" class="container">
          ...
          <div>
          <h3  style="text-align:center">Writer Login!!!</h3>
            <img src="img/writeruser.png" alt="" height="75px" width="75px"  class="center-block" ></div>
            <div>
  <form action="writerloginin.php" method="post">
